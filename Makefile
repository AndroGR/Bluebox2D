...
SOURCES=src/win_init.c src/render.c src/font.c src/message.c src/log.c src/exit.c src/event.c src/main.c src/save.c src/vector.c
INCLUDEDIR=include/
CFLAGS=-std=c99 -Wno-switch-default -pedantic -Werror=overflow -Wall -Wextra -Wcast-align -Wcast-qual -Wformat=2 -Winit-self -Wlogical-op -Wmissing-declarations -Wmissing-include-dirs -Wredundant-decls -Wsign-conversion -Wstrict-overflow=5 -Wundef -Wno-implicit-fallthrough -O3 -Wno-unused-variable -Wno-missing-declarations
